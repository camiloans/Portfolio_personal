...
function ini(){
    ...
    let nomas = false;
    var contador = 0;
    document.getElementById('ctjob').addEventListener('keyup',createJob);
    ...
    function createJob(e){
       ...
       if(e.which == 13){
        ...
        document.getElementById('jobs').appendChild(elementP);
        ...
        for(var i = 0; i < document.getElementById('jobs').getElementsByTagName('p').length;i++){
